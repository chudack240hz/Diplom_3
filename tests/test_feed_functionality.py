...
from helpers.api_helpers import get_latest_order_number
...
class TestFeedFunctionality:
    ...
    def test_count_today_increases_on_new_order(self, driver, api_user):
    ...
    def test_count_all_increases_on_new_order(self, driver, api_user):
    ...
    def test_order_appears_in_progress_section(self, driver, api_user):
